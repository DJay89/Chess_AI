...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * int c = 0; for (MoveType mt : test ) {
		 * 
		 * System.out.println(mt.getNewPos()); c++;
		 * 
		 * }
		 * 
		 * System.out.println("Tal: " + c); System.out.println(test.get(30));
		 * 
		 */

//		ArrayList<MoveType> test = new ArrayList<MoveType>();
//		for (int i = 0; i < 120; i++) {
//			if (gameState.checkField(i) != 0) {
//				test = mg.moveGen(i, gameState);
//			}
//		}
//
