...
public class GameState {
	...
	/*
	 * white | black King 11 | 12 Queen 9 | 10 Rook/tower 7 | 8 Bishop 5 | 6 Knight
	 * 3 | 4 Pawn 1 | 2
	 */
	...
	// default constructor for generating a GameState in the standard chess starting
	// position
	...
	public void oldState(MoveType move) {
		...
		currentState[move.getNewPos()] = move.getContent();
		currentState[move.getOldPos()] = move.getPiece();

	}

	/*
	 * public GameState newState(GameState state, MoveType move){ GameState newState
	 * = new GameState(); newState.setCurrentState(state.getCurrentState());
	 * 
	 * if(move.getPiece() == 11) newState.setWKingPos(move.getNewPos());
	 * 
	 * if(move.getPiece() == 12) newState.setBKingPos(move.getNewPos());
	 * 
	 * newState.setField(move.getOldPos(), 0); newState.setField(move.getNewPos(),
	 * move.getPiece());
	 * 
	 * return newState;
	 * 
