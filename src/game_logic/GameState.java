...
public class GameState {
    ...
    public GameState newState(GameState state, MoveType move){
        ...
        if(move.getPiece() == 11)
            newState.setWKingPos(move.getNewPos());
       
        if(move.getPiece() == 12)
            newState.setBKingPos(move.getNewPos());
       
        newState.setField(move.getOldPos(), 0);
        newState.setField(move.getNewPos(), move.getPiece());
